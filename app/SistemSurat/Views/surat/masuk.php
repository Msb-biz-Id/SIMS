<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
  ...
  <div class="d-flex gap-2">
    ...
    <a href="<?= base_url('sims/export-csv?tipe=masuk&' . http_build_query($filters)) ?>" class="btn btn-outline-secondary">Export CSV</a>
    <a href="<?= base_url('sims/export-pdf?tipe=masuk&' . http_build_query($filters)) ?>" class="btn btn-outline-secondary">Export PDF</a>
  </div>
</div>
