<div class="page-header d-print-none">
	<div class="row g-2 align-items-center">
		...
		<div class="col-auto ms-auto">
			<div class="btn-list">
				<a href="<?= base_url('sims/surat-create?type=masuk') ?>" class="btn btn-primary">Tambah Surat</a>
				<a href="<?= base_url('sims/export-csv?tipe=masuk&' . http_build_query($filters)) ?>" class="btn">Export CSV</a>
				<a href="<?= base_url('sims/export-pdf?tipe=masuk&' . http_build_query($filters)) ?>" class="btn">Export PDF</a>
			</div>
		</div>
	</div>
</div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="d-flex gap-2">
            <a class="btn btn-sm" href="<?= base_url('sims/surat-edit?id=' . (int)$s['id']) ?>">Edit</a>
