	...
	<div class="row g-2 align-items-center">
		...
		<div class="col-auto ms-auto">
			<div class="btn-list">
				...
				<a href="<?= base_url('sims/export-csv?tipe=keluar&' . http_build_query($filters)) ?>" class="btn">Export CSV</a>
				<a href="<?= base_url('sims/export-pdf?tipe=keluar&' . http_build_query($filters)) ?>" class="btn">Export PDF</a>
			</div>
		</div>
	</div>
</div>
